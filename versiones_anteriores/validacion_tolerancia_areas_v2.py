## ESTE CÓDIGO MARCA COMO NaN LOS REGISTROS DONDE EL ÁREA REGISTRAL ES IGUAL A 0 ##
...
def validar_tolerancia_geografica(row):
    ...
    if area_registral == 0:
        return "Area Registral invalida = 0"
...
df.to_csv('datos_predio_con_porcentajes_y_validaciones_v2.csv', index=False)
