## ESTE CODIGO ELIMINA LOS REGISTROS DONDE ÁREA REGISTRAL ES 0 ###
...
# Filtrar los predios donde 'Area Geografica' y 'Area Registral' sean mayores a 0
df = df[(df['Area Geografica'] > 0) & (df['Area Registral'] > 0)]
...
# Aplicar las funciones para calcular los porcentajes y validar la tolerancia
...
df.to_csv('datos_predio_con_porcentajes_y_validaciones.csv', index=False)
