...
# Filtrar los predios donde 'Area Geografica' sea mayor a 0 y 'Area Registral' sea mayor a 0
...
def validar_tolerancia_geografica(row):
    ...
    if 2000 < area_geografica <= 10000:
        tolerancia = 0.09
    elif 10000 < area_geografica <= 100000:  # Incluir el límite superior
        tolerancia = 0.07
    elif 100000 < area_geografica <= 500000:
        tolerancia = 0.04
    elif area_geografica > 500000:
...
df.to_csv('datos_predio_con_diferencias_porcentajes_limites_y_validaciones_v5.csv', index=False)
